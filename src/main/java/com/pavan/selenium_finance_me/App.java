package com.pavan.selenium_finance_me;
...
public class App 
{
    public static void main( String[] args ) throws InterruptedException, IOException 
    {
        ...
        driver.get("http://13.200.85.212:9002/contact.html");
        Thread.sleep(2000);
        ...
        driver.findElement(By.xpath("/html/body/div[2]/div/div/div/div[1]/div/input[1]")).sendKeys("pavan kasiboina");
        Thread.sleep(1000);
        
        System.out.println("Entering Phone Number");
        //driver.findElement(By.name("Phone Number")).sendKeys("7896834783");
        driver.findElement(By.xpath("/html/body/div[2]/div/div/div/div[1]/div/input[2]")).sendKeys("7893647489");
        Thread.sleep(1000);
        
        System.out.println("Entering Email");
        //driver.findElement(By.name("Email")).sendKeys("pavank@gmail.com");
        driver.findElement(By.xpath("/html/body/div[2]/div/div/div/div[1]/div/input[3]")).sendKeys("pavan@gmail.com");
        Thread.sleep(1000);
        
        System.out.println("Entering Message");
        //driver.findElement(By.name("Message")).sendKeys("I need more information regarding this policy");
        driver.findElement(By.xpath("//*[@id=\"comment\"]")).sendKeys("I need more info regarding this");
        Thread.sleep(2000);
